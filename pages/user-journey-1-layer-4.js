          ...
          <div className="body-flex pt-50">
            ...
            <div className="body-content py-150-100 bg-gray px-2vw">
              <div className="slide-how-to-use">
                <div className="slide-h"><img src="images/how-to-use-2-h.png" loading="lazy" sizes="(max-width: 767px) 100vw, (max-width: 991px) 701.6015625px, (max-width: 1919px) 83vw, 94vw" srcSet="images/how-to-use-2-h-p-500.png 500w, images/how-to-use-2-h-p-800.png 800w, images/how-to-use-2-h.png 886w" alt="" className="_w-100" /></div>
                <div className="slide-v">
                  ...
                  <div className="step-v-bottom">
                    <div className="text-block-4">Click the button to generate your design</div><img src="images/step2form.png" loading="lazy" sizes="(max-width: 479px) 100vw, (max-width: 767px) 86vw, 100vw" srcSet="images/step2form-p-500.png 500w, images/step2form.png 662w" alt="" className="max-w-90" />
                  </div>
                </div>
              ...
              <div className="slide-how-to-use hide">
                <div className="slide-h"><img src="images/how-to-use-3-h.png" loading="lazy" sizes="100vw" srcSet="images/how-to-use-3-h-p-500.png 500w, images/how-to-use-3-h-p-800.png 800w, images/how-to-use-3-h.png 886w" alt="" className="_w-100" /></div>
                <div className="slide-v">
...
export default UserJourney1Layer4;
