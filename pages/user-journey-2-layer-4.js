                        ...
                        <div className="_w-50 pt-100 bg-white px-2vw-1vw left-50 min-h-100vh">
                            <div className="min-h-100 d-flex-h-middle width-90pr tab-align-between">
                                ...
                                <div className="w-form">
                                    <form id="email-form" name="email-form" data-name="Email Form" method="get" data-wf-page-id="65ca3db77da0b784bbdcdb31" data-wf-element-id="feb128ce-ff19-37df-095b-453ffb6b7f9d">
                                        <div className="flex-v-center">
                                            <div className="text-block-5"><span className="text-span">Ex:</span> Create a sign up page</div>
                                            <div className="form-input"><input className="input-no-border w-input" maxLength={256} name="name" data-name="Name" placeholder="Enter instructions for your design" type="text" id="name" defaultValue="Create a sign up page" /></div>
...
export default UserJourney2Layer4;
