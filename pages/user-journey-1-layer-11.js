...
const UserJourney1Layer11 = ({ data }) => {
                ...
                <div className="w-form">
                  <form id="email-form" name="email-form" data-name="Email Form" method="get" data-wf-page-id="65c650e9190eb761095d735e" data-wf-element-id="feb128ce-ff19-37df-095b-453ffb6b7f9d">
                    <div className="flex-v-center">
                      <div className="form-input"><input className="input-no-border w-input" maxLength={256} name="name" data-name="Name" value="Create a sign in page" type="text" id="name" /></div>
...
export default UserJourney1Layer11;
