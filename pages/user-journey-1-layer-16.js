...
const UserJourney1Layer16 = ({ data }) => {
                    ...
                    <div className="body-flex-tab-v">
                        <div className="_w-50 pt-100 bg-white px-2vw-1vw left-50 min-h-100vh">
                            <div className="min-h-100 d-flex-h-middle width-90pr tab-align-between">
                                ...
                                <div className="w-form">
                                    <form id="email-form" name="email-form" data-name="Email Form" method="get" data-wf-page-id="65c66f1b9dfc7bbc73e3237f" data-wf-element-id="feb128ce-ff19-37df-095b-453ffb6b7f9d">
                                        <div className="flex-v-center">
                                            ...
                                            <div className="d-block-md mb-40"><img src="images/image-breakpoints.png" loading="lazy" sizes="(max-width: 479px) 87vw, (max-width: 767px) 86vw, 100vw" srcSet="images/image-breakpoints-p-500.png 500w, images/image-breakpoints.png 692w" alt="" className="margin-x-auto shadowimg" /></div>
                        ...
                        <div className="_w-50 pt-100 bg-gray px-1vw-2vw right-50">
                            <div className="min-h-100 d-flex-h-middle align-around">
                                <div className="max-width-90pr"><img src="images/image-breakpoints.png" loading="lazy" sizes="(max-width: 767px) 100vw, (max-width: 991px) 419.296875px, (max-width: 1919px) 42vw, 691.9921875px" srcSet="images/image-breakpoints-p-500.png 500w, images/image-breakpoints.png 692w" alt="" className="margin-x-auto shadowimg" /></div>
...
export default UserJourney1Layer16;
