...
const UserJourney1Layer12 = ({ data }) => {
                    ...
                    <div className="body-flex-tab-v">
                        <div className="_w-50 pt-100 bg-white px-2vw-1vw left-50 min-h-100vh">
                            <div className="min-h-100 d-flex-h-middle width-90pr tab-align-between">
                                ...
                                <div className="d-block-md mb-50 d-flex">
                                    <div className="position-relative"><img src="images/uj-1-l-9-img2.png" loading="lazy" alt="" className="margin-x-auto shadowimg radius-20" />
                                        <div className="progress-overlay">
                                            <div className="progress-anim-wrapper-mid-center"><img src="images/loading-img.png" loading="lazy" alt="" /></div>
                                        </div>
                                    </div>
                                </div>
                                <div className="w-form">
                                    <form id="email-form" name="email-form" data-name="Email Form" method="get" data-wf-page-id="65c6531442998067bf21c8c5" data-wf-element-id="feb128ce-ff19-37df-095b-453ffb6b7f9d">
                        ...
                        <div className="_w-50 pt-100 bg-gray px-1vw-2vw right-50">
                            <div className="min-h-100 d-flex-h-middle pb-50 align-center">
                                <div className="position-relative"><img src="images/uj-1-l-9-img2.png" loading="lazy" alt="" className="margin-x-auto shadowimg radius-20" />
                                    <div className="progress-overlay">
                                        <div className="progress-anim-wrapper-mid-center"><img src="images/loading-img.png" loading="lazy" alt="" /></div>
                                    </div>
...
export default UserJourney1Layer12;
