        ...
        <div className="max-width-482">
          <div className="d-block-column justify-center"><img src="images/logo1.png" loading="lazy" alt="" />
            ...
            <div className="form-block w-form">
              <form id="email-form" name="email-form" data-name="Email Form" method="get" data-wf-page-id="65c3be8f30b8e29194fc60ff" data-wf-element-id="d2aa9f5e-e2b4-be80-88e9-8b2a881250f9">
                ...
                </div><input className="text-field w-input" maxLength={256} name="Password" data-name="Password" placeholder="Enter your password" type="password" id="Password" required /><input type="submit" data-wait="Please wait..." className="btn-sign-up w-button" defaultValue="Sign Up" />
              </form>
            ...
            <div className="mt-48">
              <div className="text-block-2">Already have an account? &nbsp;<a href="#" className="link">Sign In</a>
              </div>
            </div>
          </div>
        </div>
