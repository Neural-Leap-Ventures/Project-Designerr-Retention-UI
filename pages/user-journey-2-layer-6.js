                        ...
                        <div className="_w-50 pt-100 bg-white px-2vw-1vw left-50 min-h-100vh">
                            <div className="min-h-100 d-flex-h-middle width-90pr tab-align-between">
                                ...
                                <div className="w-form">
                                    <form id="email-form" name="email-form" data-name="Email Form" method="get" data-wf-page-id="65ca3efad1677bacee9b8e41" data-wf-element-id="feb128ce-ff19-37df-095b-453ffb6b7f9d">
...
export default UserJourney2Layer6;
